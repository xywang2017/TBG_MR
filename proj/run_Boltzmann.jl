...
save(joinpath(fpath,"strain/transport/eps_$(str)_phi_$(ϕ)_Da_$(str2).jld"),"transport",transport_coefficients,"FS",FS_collect)
# save(joinpath(fpath,"strain/transport/eps_$(str)_phi_$(ϕ)_Da_$(str2)_$(lk).jld"),"transport",transport_coefficients)
ϵa = 1260.88
ω0τs = eBτs * ϵa
transport_coefficients = load(joinpath(fpath,"strain/transport/eps_$(str)_phi_$(ϕ)_Da_$(str2).jld"),"transport")
